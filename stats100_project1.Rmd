...
bBall = read.csv("basketball-2021.csv") #%>% filter(Date > )
dim(bBall)
...
# SALARY RANKE NOT CORRECT -> USE NBA RANK

#plot(x = dfResult$Salaries, y = dfResult$NBASalaries.Rk,
 #  xlab = "Salaries (millions)",
  # ylab = "Rank (lower better)",	 
...
plot(x = dfStandings$Salaries, y = dfStandings$rank,
   xlab = "Salaries (millions)",
   ylab = "Performance by ranking from number of wins",	 
   main = "Salaries vs Performance"
)
```
